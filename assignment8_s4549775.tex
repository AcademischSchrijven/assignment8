...
\section{Abstract}
In this paper I present an easy to understand and follow appraoch to detect an object's position, and the direction it is facing, from visual input using OpenCV. This is done as a case study of an autonomous football playing robot.
